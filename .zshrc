eval "$(oh-my-posh init zsh --config $HOME/.cache/oh-my-posh/themes/mycatppuccin.omp.json)"
...
zstyle ':fzf-tab:complete:cd:*' fzf-preview 'lsd --tree --color=always $realpath'
zstyle ':fzf-tab:complete:cd:*' fzf-flags --border --info=inline --height 60%
